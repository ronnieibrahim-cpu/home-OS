...
import { House, Armchair, Plus, Wallet, LineChart } from "lucide-react";
        ...
        {items.map(({ href, label, icon: Icon }) => {
          ...
          return (
            <Link
              ...
              href={href}
              className={cn(
                "flex flex-1 flex-col items-center gap-1 py-2.5 text-xs transition-opacity active:opacity-60",
